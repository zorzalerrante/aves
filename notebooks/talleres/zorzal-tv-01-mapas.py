...
# aquí usamos contextily para mostrar un basemap que descargamos en el notebook 03-python-mapas-preliminario.ipynb
# después podemos agregar el parámetro basemap="../data/processed/scl_toner_12.tif" 
# a figure_from_geodatafame y ahorrarnos esta líneas
